  ...
  editCar: async (req, res) => {
    ...
    try {
      ...
      if (!car.isAvailable) {
        ...
        return res.status(400).json({
          success: false,
          message: "Cannot edit car data after it's sold. Edit sale details instead."
        });
      }
      ...
      const allowedFields = [
        "brand", "year", "enginePower", "gear", "color", "images",
        "kilo", "wheelDrive", "purchaseDate", "purchasePrice", 
        "priceToSell", "licenseNo"
      ];
